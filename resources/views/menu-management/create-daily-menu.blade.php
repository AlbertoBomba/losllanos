...
<head>
    ...
    <title>Nuevo Menú Diario - {{ $restaurant->name }}</title>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Nuevo Menú Diario</h1>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="p-6">
                    <form action="{{ route('menu-management.daily-menu.store', $restaurant) }}" method="POST" class="space-y-8">
                        @csrf
                        ...
                        <div>
                            ...
                            <textarea id="description" 
                                      ...
                                      rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                      placeholder="Descripción del menú, qué incluye, características especiales...">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <div id="first-courses-container" class="space-y-3">
                                @if(old('first_courses'))
                                    @foreach(old('first_courses') as $index => $course)
                        ...
                        <div>
                            ...
                            <div id="second-courses-container" class="space-y-3">
                                @if(old('second_courses'))
                                    @foreach(old('second_courses') as $index => $course)
                                        <div class="flex gap-2 course-item">
                                            <input type="text" 
                                                   name="second_courses[]" 
                                                   value="{{ $course }}"
                        ...
                        <div>
                            ...
                            <div id="desserts-container" class="space-y-3">
                                @if(old('desserts'))
                                    @foreach(old('desserts') as $index => $dessert)
                                        <div class="flex gap-2 course-item">
                                            <input type="text" 
                                                   name="desserts[]" 
                                                   value="{{ $dessert }}"
                        ...
                        <div>
                            ...
                            <div id="drinks-container" class="space-y-3">
                                @if(old('drinks'))
                                    @foreach(old('drinks') as $index => $drink)
                                        <div class="flex gap-2 course-item">
                                            <input type="text" 
                                                   name="drinks[]" 
                                                   value="{{ $drink }}"
                        ...
                        <div>
                            ...
                            <textarea id="notes" 
                                      ...
                                      maxlength="500"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                      placeholder="Ej: Incluye pan y bebida, Solo de lunes a viernes, etc...">{{ old('notes') }}</textarea>
