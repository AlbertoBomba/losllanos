...
@section('title', 'Palomas para Suelta - Venta Directa | Los Llanos Toledo')
    ...
    <section class="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-[#f5f1e3]">
        ...
        <div class="relative z-20 text-center text-white px-6 max-w-5xl mx-auto pt-20">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button onclick="window.open('https://wa.me/34925123456?text=Hola,%20me%20interesa%20información%20sobre%20palomas%20para%20suelta', '_blank')" 
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            <button onclick="window.open('mailto:info@losllanos.com?subject=Consulta Palomas - Los Llanos&body=Hola,%20me%20interesa%20información%20sobre%20palomas%20para%20suelta.%20Por%20favor%20contacten%20conmigo.', '_self')" 
        ...
        <div class="container mx-auto px-6">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-4xl font-display font-bold text-white mb-6 uppercase tracking-wide">
                    Palomas de Calidad Superior
                </h2>
                <p class="text-xl text-gray-200 mb-8 font-sans leading-relaxed">
                    Contacta ahora y consigue las mejores palomas deportivas de Toledo. 
                    Velocidad y emoción garantizadas en cada suelta.
                </p>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <button onclick="window.open('https://wa.me/34925123456?text=Hola,%20quiero%20comprar%20palomas%20para%20suelta', '_blank')" 
                ...
                <div class="mt-8 text-gray-200 font-sans text-sm">
                    <p>📍 <strong>Los Llanos, Toledo</strong> | 🕒 <strong>Disponible todo el año</strong> | 🚚 <strong>Transporte incluido</strong></p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="bg-gradient-to-br from-[#4b5d3a] to-[#3a4a2c] rounded-2xl shadow-2xl p-4 lg:p-6 w-16 lg:w-64 lg:max-w-xs">
            ...
            <div class="hidden lg:block text-center mb-4">
                <div class="w-12 h-12 bg-white rounded-full flex items-center justify-center mx-auto mb-3">
                    <i class="fas fa-dove text-[#4b5d3a] text-xl"></i>
                </div>
