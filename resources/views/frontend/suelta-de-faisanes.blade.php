...
@section('title', ' [ suelta de faisanes ] Los Llanos Toledo ✔️')
@section('description', '⭐ Realizamos suelta de faisanes en nuestra finca. Jornada completa de caza, con alm                                <div class="grid grid-cols-2 gap-3 text-sm">
                                    <div>
                                        <span class="font-semibold text-gray-600">Especies:</span>
                                        <div class="text-[#f59e0b] font-bold">PERDICES</div>
...
restaurante privado. Animales de gran porte, espectácular cazarlos..')
    ...
    <section class="relative min-h-[50vh] sm:min-h-[60vh] lg:min-h-[70vh] flex items-center justify-center overflow-hidden bg-[#f5f1e3] p-2 sm:p-4">
        ...
        <div class="absolute inset-0 z-0">
            <img src="{{asset('images/general/cazador-faisan.webp')}}" 
                 alt="cazando faisanes en finca los llanos" 
        ...
        <div class="relative z-20 text-center text-white px-3 sm:px-6 max-w-5xl mx-auto pt-16 sm:pt-20 lg:pt-24">
            ...
            <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-display font-bold mb-4 sm:mb-6 leading-tight tracking-wide uppercase">
                Calendario de suelta de faisanes en Finca los llanos
            </h1>
            ...
            <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                <button onclick="window.open('tel:+34608910639', '_self')" 
                        class="bg-[#f59e0b] hover:bg-[#d97706] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-action font-bold text-base sm:text-lg tracking-wide uppercase transition-all duration-300 hover:scale-105 shadow-lg">
                    <i class="fas fa-phone mr-2"></i>
                    Reservar puesto
                </button>
                <button onclick="window.open('https://wa.me/34608910639?text=Hola,%20me%20interesa%20información%20sobre%20faisanes', '_blank')" 
            ...
            <nav class="flex mb-6 sm:mb-8" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3 text-sm sm:text-base">
                    <li class="inline-flex items-center">
                        <a href="{{ route('home') }}" title="Ir a la página de inicio" class="inline-flex items-center text-base sm:text-lg lg:text-xl font-medium text-gray-700 hover:text-[#f59e0b]">
                    ...
                    <li>
                        <a href="{{ route('productos') }}" title="Ir a la página de productos" class="inline-flex items-center text-base sm:text-lg lg:text-xl font-medium text-gray-700 hover:text-[#f59e0b]">
                    ...
                    <li>
                        <a href="{{ route('productos.sueltas') }}" title="Ir a la categoría de aves de caza" class="inline-flex items-center text-base sm:text-lg lg:text-xl font-medium text-gray-700 hover:text-[#f59e0b]">
                            <div class="flex items-center">
                                <svg class="w-3 h-3 text-gray-400 mx-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"/>
                                </svg>
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 font-medium text-gray-500 md:ml-2 hidden sm:inline">Faisanes</span>
                            <span class="ml-1 font-medium text-gray-500 md:ml-2 sm:hidden">Faisanes</span>
                        </div>
                    </li>
                </ol>
            </nav>
                        ...
                        <table class="w-full text-sm text-center">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-3 py-4 font-semibold text-[#f59e0b] bg-gray-100">
                                        <div>PERDICES</div>
                ...
                <div class="relative order-1 lg:order-1">
                    <div class="aspect-w-16 aspect-h-12 rounded-xl sm:rounded-2xl overflow-hidden shadow-xl sm:shadow-2xl mb-4 sm:mb-6">
                        ...
                        <video src="{{asset('media/tirada-los-llanos.mp4')}}"
                               ...
                               controls
                               preload="metadata"
                               poster="{{asset('images/general/cazador-faisan.webp')}}">
                        </video>
                    </div>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4">
                        <img src="{{asset('images/galery/19.JPG')}}" 
                             ...
                             class="thumbnail w-full h-16 sm:h-20 md:h-24 object-cover object-top rounded-md sm:rounded-lg cursor-pointer border-2 border-[#f59e0b] opacity-100"
                ...
                <div class="space-y-6 sm:space-y-8 order-2 lg:order-2">
                    ...
                    <div>
                        <div class="flex flex-wrap items-center gap-2 sm:gap-4 mb-3 sm:mb-4">
                            <span class="bg-[#f59e0b] text-white px-2 sm:px-3 py-1 rounded-full font-action font-semibold text-xs sm:text-sm tracking-wide uppercase">
                                Faisanes
                            </span>
                        ...
                        <h2 class="text-2xl sm:text-3xl lg:text-4xl font-display font-bold text-dark mb-3 sm:mb-4 uppercase tracking-wide leading-tight">
                           Tiradas privadas faisanes
                        </h2>
                        <div class="flex flex-col sm:flex-row sm:items-center mb-4 sm:mb-6">
                            <div class="text-2xl sm:text-3xl font-display font-bold text-[#f59e0b] mb-1 sm:mb-0 sm:mr-4">Precio a consultar</div>
                    ...
                    <div class="space-y-3 sm:space-y-4">
                        <button onclick="window.open('tel:+34608910639', '_self')" 
                                class="w-full bg-[#f59e0b] hover:bg-[#d97706] text-white py-3 sm:py-4 px-4 sm:px-6 rounded-lg font-action font-bold text-base sm:text-lg tracking-wide uppercase transition-all duration-300 hover:scale-105 shadow-lg">
                            <i class="fas fa-phone mr-2"></i>
                        ...
                        <div class="grid sm:grid-cols-2 gap-3 sm:gap-4">
                            <button onclick="window.open('mailto:att@clubdetiro-losllanos.es?subject=Consulta faisanes - Los Llanos&body=Hola,%20me%20interesa%20información%20sobre%20faisanes.%20Por%20favor%20contacten%20conmigo.', '_self')" 
                                    class="w-full border-2 border-[#f59e0b] text-[#f59e0b] hover:bg-[#f59e0b] hover:text-white py-2 sm:py-3 px-3 sm:px-4 rounded-lg font-action font-semibold text-sm sm:text-base tracking-wide uppercase transition-all duration-300">
                                <i class="fas fa-envelope mr-2"></i>
                                Email
                            </button>
                            <button onclick="window.open('https://wa.me/34608910639?text=Hola,%20me%20interesa%20información%20sobre%20faisanes%20para%20coto%20de%20caza%20intensivo.', '_blank')" 
                        ...
                        <div class="flex w-full mx-auto p-3 sm:p-4 items-center justify-center mt-8 sm:mt-12">
                            <p class="text-gray-600 font-sans leading-relaxed text-base sm:text-lg lg:text-xl max-w-4xl text-left">
                                <strong>Suelta de faisanes en campo de tiro los llanos.</strong><br >
                                Animales de gran porte,<strong> disfruta a lo grande.</strong><br />
                                <br />
                        ...
                        <div class="grid sm:grid-cols-2 gap-4 sm:gap-6">
                            <div class="space-y-3 sm:space-y-4">
                                ...
                                <div class="space-y-2 sm:space-y-3">
                                    <div class="flex items-center">
                                        <i class="fas fa-check-circle text-[#f59e0b] mr-2 sm:mr-3 text-sm sm:text-base"></i>
                            ...
                            <div class="space-y-3 sm:space-y-4">
                                ...
                                <div class="space-y-2 sm:space-y-3">
                                    <div class="flex items-center">
                                        <i class="fas fa-certificate text-[#f59e0b] mr-2 sm:mr-3 text-sm sm:text-base"></i>
                                        <span class="font-sans text-gray-700 text-sm sm:text-base">Certificados sanitarios</span>
                                    </div>
                                    <div class="flex items-center">
                                        <i class="fas fa-user-tie text-[#f59e0b] mr-2 sm:mr-3 text-sm sm:text-base"></i>
                                        <span class="font-sans text-gray-700 text-sm sm:text-base">Asesoramiento técnico</span>
                                    </div>
                                    <div class="flex items-center">
                                        <i class="fas fa-phone text-[#f59e0b] mr-2 sm:mr-3 text-sm sm:text-base"></i>
    ...
    <section class="py-12 sm:py-16 lg:py-20 bg-[#f5f1e3]">
        <div class="container mx-auto px-3 sm:px-6">
            <div class="text-center mb-8 sm:mb-12 lg:mb-16">
                <h2 class="text-2xl sm:text-3xl lg:text-4xl font-display font-bold text-dark mb-3 sm:mb-4 uppercase tracking-wide leading-tight">
                    ¿Por Qué Elegir Nuestras <span class="block sm:inline">suelta de faisanes?</span>
                </h2>
            </div>
