...
@section('title', '[ Venta de codornices ] Los Llanos Toledo ✔️')
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center text-xl">
                            ...
                            <span class="ml-1  font-medium text-gray-500 md:ml-2">Codornices</span>
                        </div>
                    </li>
                </ol>
            </nav>
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            <button onclick="window.open('mailto:att@clubdetiro-losllanos.es?subject=Consulta Codornices Comunes - Los Llanos&body=Hola,%20me%20interesa%20información%20sobre%20codornices%20comunes.%20Por%20favor%20contacten%20conmigo.', '_self')" 
                            ...
                            <button onclick="window.open('https://wa.me/34608910639?text=Hola,%20me%20interesa%20información%20sobre%20codornices%20comunes%20para%20suelta', '_blank')" 
